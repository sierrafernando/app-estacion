	...
	<div id="contenido">
		<div id="panel-container">
			<div id="panel-title">
				...
				<div class="title-info">
					<i class="material-symbols-outlined rojo">location_on</i><h2 id="ubicacion">Córdoba, Aeroclub La Cumbre</h2>
				</div>
				<h4 id="title-sub"><i class="material-symbols-outlined amarillo">device_thermostat</i>TEMPERATURA</h4>
			</div>
			<div id="panel-container-temperatura" style="display: visible;">
				<div class="panel-col">
					<div class="col-items">
						<div class="item-title">
							<i class="material-symbols-outlined amarillo">device_thermostat</i>TEMPERATURA
						</div>
					</div>
					<div class="col-items">
				...
				<div class="panel-col">
					<div class="col-items">
						<div class="item-title">
							<i class="material-symbols-outlined celeste">emoji_people</i>SENSACIÓN
						</div>
					</div>
					<div class="col-items">
						<div class="col-important">
			...
			<div id="panel-container-viento" style="display: none">
				<div class="panel-col">
					...
					<div class="col-items">
						...
						<div class="panel-row">
							<div class="item">
								<div class="item-title"><i class="material-symbols-outlined rojo">arrow_drop_up</i>Máximo</div>
				...
				<div class="panel-col">
					<div class="panel-row">
							<div class="item">
								<div id="item-viento">
									<i class="material-symbols-outlined rojo">explore</i>
